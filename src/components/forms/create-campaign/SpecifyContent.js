    ...
    <>
      ...
      <div className="form">
        <div className="form-title" style={{ textAlign: 'center' }}>
          <h6 style={{ color: '#1b3b6d' }}>Specify Content</h6>
          <p style={{ color: '#545d70', fontWeight: '300' }}>
            Specify your campaign content
                </p>
        </div>
